...
from lib.scheduler_cli import configuration
from lib.scheduler_cli.boto_retry import add_retry_methods_to_resource
from lib.scheduler_cli.configuration.config_dynamodb_adapter import ConfigDynamodbAdapter
from lib.scheduler_cli.configuration.instance_schedule import InstanceSchedule
from lib.scheduler_cli.configuration.scheduler_config_builder import SchedulerConfigBuilder
from lib.scheduler_cli.configuration.setbuilders.month_setbuilder import MonthSetBuilder
from lib.scheduler_cli.configuration.setbuilders.monthday_setbuilder import MonthdaySetBuilder
from lib.scheduler_cli.configuration.setbuilders.weekday_setbuilder import WeekdaySetBuilder
from lib.scheduler_cli.util.named_tuple_builder import as_namedtuple
...
class ConfigAdmin:
    ...
    def __init__(self, logger, context, config_table=None):
        """
        Initializes the config API
        :param logger: logger for the admin api
        :param context: Lambda context
        """
        self._table_name = config_table
